...
import { PatientPathwayAppointmentCreatorComponent } from './components/creators/patient-pathway-appointment-creator/patient-pathway-appointment-creator.component';
...
@NgModule({
  declarations: [
    ...
    PatientPathwayAppointmentCreatorComponent,
